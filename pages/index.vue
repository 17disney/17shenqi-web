  ...
  <div>
    <div class="container">
      ...
      <transition name="el-fade-in-linear">
        <timesguide-list v-show="listShow" @click="handleClickTimesguide" :columns="columns" :list="activeList"></timesguide-list>
      </transition>
      <div v-if="!listShow" class="list-loading" v-loading="loading">
...
export default {
  ...
  methods: {
    async init() {
      ...
      this.listShow = false
      // this.list = []
      this.columns = TIMESGUIDE_TYPE_LIST.find(_ => _.id === this.type)['columns']
